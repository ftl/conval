...
func (c *Counter) ProbeQTC(qtc QTC) QTCScore {
	...
	qtcRules := c.filterScoringRules(c.definition.Scoring.QTCRules, mostRelevantRule, c.setup.MyContinent, c.setup.MyCountry, c.setup.MyPrefix(), qtc.TheirContinent, qtc.TheirCountry, qtc.TheirPrefix(), qtc.Band, time.Time{}, qtc.Kind, getMyProperty, getTheirProperty)
